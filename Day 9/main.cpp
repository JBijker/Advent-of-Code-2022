...
int main() {
    ...
    int rope_length = 10;
    std::vector<std::vector<int>> rope(rope_length, std::vector<int>(2));
    ...
    if (file.is_open()) {
        ...
        while (file) {
            ...
            for (int i = 0; i < steps; ++i) {
                ...
                std::cout << "pos: <" << rope[0][0] << ", " << rope[0][1] << ">" << " <" << rope[rope.size()-1][0] << ", " << rope[rope.size()-1][1] << ">"
                          << std::endl;
